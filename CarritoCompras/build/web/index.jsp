...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>💯Super Brothers Store💥</i></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <script>
                    document.getElementById("btnBuscar").addEventListener("click", function () {
                        var searchText = document.getElementById("txtBuscar").value;
                        // Realizar la búsqueda utilizando el valor de searchText

                        // Redirigir a la página de resultados de búsqueda
                        window.location.href = "Controlador?accion=Buscar&txtbuscar=" + encodeURIComponent(searchText);
                    });
                </script>
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-body text-center d-flex">
                                    <label class="font-weight-bold">BOB. ${p.getPrecio()}</label>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input type="text" name="txtnom" class="form-control" placeholder="Ronald Perez">
                                        </div>
                                        <div class="form-group">
                                            <label>CI</label>
                                            <input type="text" maxlength="8" name="txtCI" class="form-control" placeholder="9915483">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input type="text" name="txtdire" class="form-control" placeholder="El Alto - La Paz">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" name="txtemail" class="form-control" placeholder="email@example.com">
