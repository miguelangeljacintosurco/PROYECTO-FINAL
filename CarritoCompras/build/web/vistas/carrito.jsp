...
<%@page import="com.emer.config.Fecha"%>
                ...
                <div class="col-lg-3">                  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a class="form-control text-center"><i class="h5"> BOB. ${totalPagar}0</i></a>
                            <label>Precio Envio:</label>
                            <a class="form-control text-center"><i class=" h5">BOB.  0.00</i></a>
                            <label>Descuento:</label>
                            <a class="form-control text-center"><i class=" h5">BOB. 0.00</i></a>
                            <label>Total a Pagar:</label>
                            <a class="form-control text-center"><i class=" h4 primary">BOB. ${totalPagar}0</i></a>
                        </div>
