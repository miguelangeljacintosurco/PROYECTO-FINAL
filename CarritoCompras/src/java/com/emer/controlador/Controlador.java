package com.emer.controlador;

import com.emer.config.Fecha;
import com.emer.modelo.Carrito;
import com.emer.modelo.Cliente;
import com.emer.modelo.ClienteDAO;
import com.emer.modelo.Compra;
import com.emer.modelo.ComprasDAO;
import com.emer.modelo.DetalleCompra;
import com.emer.modelo.Pago;
import com.emer.modelo.Producto;
import com.emer.modelo.ProductoDAO;
import java.io.File;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            ...
            case "Registrar":
                ...
                String CI = request.getParameter("txtdni");
            ...
            case "Editar":
                idProducto = Integer.parseInt(request.getParameter("id"));
                Producto productoEditar = pdao.listarId(idProducto);
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            ...
                            fileItem.write(file);
                            p.setImagen("https//localhost:8081/carrito/" + fileItem.getName());
                        } else {
