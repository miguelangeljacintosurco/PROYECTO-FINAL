                        ...
                        <tbody>
                            <c:forEach var="p" items="${productos}">
                                <tr class="text-center">
                                    ...
                                    <td>${p.getStock()}</td>
                                    <td class="d-flex">
                                        <a href="./Controlador?accion=Editar" class="btn btn-warning" onclick="editarProducto(${p.getId()})">Editar</a>
                                        <a href="./Controlador?accion=deleteProducto" class="btn btn-danger">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>                           
                        </tbody>
